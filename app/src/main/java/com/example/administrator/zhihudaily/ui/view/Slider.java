package com.example.administrator.zhihudaily.ui.view;
...
public class Slider extends FrameLayout implements OnClickListener {
    ...
    public void setTopEntities(List<LatestResult.TopStoriesEntity> topEntities) {
    ...
    private void initUI() {
        ...
        for (int i = 0; i <= len + 1; i++) {
            ...
            if (i == 0) {
                ...
                Glide.with(iv.getContext())
                        .load(topStoriesEntities.get(0).getImage())
                        .into(iv);
                tv_title.setText(topStoriesEntities.get(0).getTitle());
            } else {
                Glide.with(iv.getContext())
                        .load(topStoriesEntities.get(i - 1).getImage())
                        .into(iv);
    ...
    public void onClick(View v) {
        if (mItemClickListener != null) {
            LatestResult.TopStoriesEntity entity = topStoriesEntities.get(vp.getCurrentItem() - 1);
